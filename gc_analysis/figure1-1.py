...
# ==============================================================================
"""Generates Data for Figure1-1. General Behavior of T and WT """
...
path = r'\\philliplab-server.wse.jhu.edu\data\Chanhong\Cornell LN Spleen\Analysis\Figure1. Dynamic Behavior of T and WT\Overall behavior\\'
...
df_long_ = df_long.replace({'Type': {'wt_B-cell': 'WT', 'T-cell': 'Tfh'}})
