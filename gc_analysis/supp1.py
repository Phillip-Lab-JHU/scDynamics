...
ax.set_xlabel('Number of frames', fontsize=8, weight='bold')
ax.set_ylabel('Density of tracked cells', fontsize=8, weight='bold')
...
ax.set_ylabel('Number of tracked cells', fontsize=8, weight='bold', color='0.2')
