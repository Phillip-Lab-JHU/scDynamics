...
path = r'\\philliplab-server.wse.jhu.edu\data\Chanhong\Cornell LN Spleen\Analysis_test\Figure5. Inhibition\Overall\\'

#################################### Plot whole state space ####################################
df_ = df.replace({'Type': {'wt_B-cell': 'wt GCB', 'mt_B-cell': 'mt GCB'}})
df_inhibit_ = df_inhibit.replace({'Type': {'wt_B-cell': 'wt GCB', 'mt_B-cell': 'mt GCB'}})
...
df_inhibit_ = df_inhibit_.replace({'Type': {'wt_B-cell': 'wt GCB', 'mt_B-cell': 'mt GCB'}})
...
group_clones=[]
for group in ['wt GCB Control', 'wt GCB IgG', 'wt GCB CD40L', 'mt GCB Control', 'mt GCB IgG', 'mt GCB CD40L']:
...
for feature_name in feature_list:
    ...
    draw_custom_violin_plot(dataset, path + 'feature_violin_plot_inhibit/', file_name=feature_name,
                            colors=('#888888', '#888888', '#888888', '#888888', '#CC6677', '#CC6677', '#CC6677', '#CC6677'), test='mann-whitney', pvalue=True, figsize=(2, 2))
...
######################## interaction features mt vs wt GCB box plot  ###########################
...
feature_list = df.columns[148:].drop(['PC1', 'PC2', 'kmeans', 'Inhibition'])
