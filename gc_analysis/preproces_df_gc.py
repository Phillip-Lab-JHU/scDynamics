...
df.to_csv(path + 'long_traj_duration_%s.csv' % duration, index=False)
df.to_parquet(path + 'long_traj_duration_%s.parquet' % duration)
...
df_duration.to_csv(path + 'long_traj_duration_%s.csv' % duration, index=False)
df_duration.to_parquet(path + 'long_traj_duration_%s.parquet' % duration)
...
df_labels = df_labels[['TrackID', 'Time', 'pseudo_Time', 'Label', 'pseudo_Label', 'Type', 'Video', 'Exp', 'Day',
                       'Exp_group', 'Time_span', 'instant_speed', 'instant_angle']]
...
########################################################################################################
### 8. Classification of mt & wt GCB / wt GCB & Tfh
