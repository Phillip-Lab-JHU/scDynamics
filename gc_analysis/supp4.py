...
####################################### Instantaneous shortest distance histogram Ezh2 GCB vs WT GCB wrt to FDC and T cell #############################################
...
kdeplot = sns.kdeplot(df_wt[shortest_distance_features[0]], fill=True, linewidth=2, clip=(0.0, 40), label='wt GCB-FDC')
kdeplot = sns.kdeplot(df_mt[shortest_distance_features[0]], fill=True, linewidth=2, clip=(0.0, 40), label='mt GCB-FDC')
plt.legend()
...
fig = plt.figure()
sns.set(context='notebook', style='ticks', font_scale=1)
kdeplot = sns.kdeplot(df_wt[shortest_distance_features[3]], fill=True, linewidth=2, clip=(0.0, 40), label='wt GCB-T')
kdeplot = sns.kdeplot(df_mt[shortest_distance_features[3]], fill=True, linewidth=2, clip=(0.0, 40), label='mt GCB-T')
plt.legend()
...
####################################### Number of Ezh2 GCB vs WT GCB with Exp group 2 and Exp group 3 #############################################
...
for i, interaction_type in enumerate(['FDC', 'wt_B-cell', 'mt_B-cell']):
    ...
    #plt.xticks(plt.xticks()[0], sorted_keys, fontsize=9.5, fontdict={'weight': 'bold'})
