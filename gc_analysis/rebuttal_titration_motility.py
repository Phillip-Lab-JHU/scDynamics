...
for feature in feature_list:
    ...
    os.makedirs(path+'/motility_feature_type_dominance_sc/', exist_ok=True)
    draw_custom_box_plot(dict_datasets, path+'motility_feature_type_dominance_sc/',
                         file_name='%s'%feature,
                         colors = ('#888888', '#CC6677')*3, strip_plot=False,
                         test='one-way anova_tukey', # 'one-way anova_tukey'
                         pvalue=True, figsize=(2,3))
...
for feature in feature_list:
    ...
    os.makedirs(path+'/motility_feature_type_dominance/', exist_ok=True)
    draw_custom_bar_plot(dict_datasets, path+'motility_feature_type_dominance/',
                         file_name='%s'%feature,
