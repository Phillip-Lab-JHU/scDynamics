...
df_mid = df[df['Type']=='Mid'].reset_index(drop=True)
df_old = df[df['Type']=='Old'].reset_index(drop=True)

for group in np.unique(df['Type']):
    df_part = df[df['Type']==group].reset_index(drop=True)
    for cond in np.unique(df_part['Senescence']):
        df_part_part = df_part[df_part['Senescence']==cond].reset_index(drop=True)
        print(group, cond, df_part_part.shape[0], np.unique(df_part_part['Cell Line']).shape[0])


path = r'\\philliplab-server.wse.jhu.edu\data\Chanhong\Anshika motility project\figure2. age-dependent senescence\\'
...
draw_umap_space(df_young, young_path, file_name='motility space_senescence_young', condition_name='Senescence', label_name='pseudo_label',
                colors = ('#888888', '#B589C3'), dot_size=0.07, x_name='PC1', y_name='PC2')
draw_umap_space(df_young, young_path, file_name='motility space_exact_age_young', condition_name='Age', label_name='pseudo_label',
                colors = cmc.turku, dot_size=0.07, x_name='PC1', y_name='PC2')


draw_jointplot(xs='PC1', y='PC2', df=df_young, path=young_path, file_name='jointplot_senescence', hue="Senescence", colors=('#888888', '#B589C3'),
               hue_order=[0, 1], legend=False, fill=False, thresh=0.2, height=4, ratio=5, space=0, xlabels='UMAP1', ylabel='UMAP2',
               xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax)
draw_jointplot(xs='PC1', y='PC2', df=df_young, path=young_path, file_name='jointplot_age', hue="Age", colors=cmc.turku,
               legend=True, fill=False, thresh=0.6, height=4, ratio=5, space=0, xlabels='UMAP1', ylabel='UMAP2',
               xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax)

########################################################################

draw_umap_space(df_mid, mid_path, file_name='motility space_senescence_young', condition_name='Senescence', label_name='pseudo_label',
                colors = ('#888888', '#B589C3'), dot_size=0.07, x_name='PC1', y_name='PC2')
draw_umap_space(df_mid, mid_path, file_name='motility space_exact_age_young', condition_name='Age', label_name='pseudo_label',
                colors = cmc.turku, dot_size=0.07, x_name='PC1', y_name='PC2')


draw_jointplot(xs='PC1', y='PC2', df=df_mid, path=mid_path, file_name='jointplot_senescence', hue="Senescence", colors=('#888888', '#B589C3'),
               hue_order=[0, 1], legend=False, fill=False, thresh=0.2, height=4, ratio=5, space=0, xlabels='UMAP1', ylabel='UMAP2',
               xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax)
draw_jointplot(xs='PC1', y='PC2', df=df_mid, path=mid_path, file_name='jointplot_age', hue="Age", colors=cmc.turku,
               legend=True, fill=False, thresh=0.6, height=4, ratio=5, space=0, xlabels='UMAP1', ylabel='UMAP2',
               xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax)

########################################################################
draw_umap_space(df_old, old_path, file_name='motility space_senescence_young', condition_name='Senescence', label_name='pseudo_label',
                colors = ('#888888', '#B589C3'), dot_size=0.07, x_name='PC1', y_name='PC2')
draw_umap_space(df_old, old_path, file_name='motility space_exact_age_young', condition_name='Age', label_name='pseudo_label',
                colors = cmc.turku, dot_size=0.07, x_name='PC1', y_name='PC2')


draw_jointplot(xs='PC1', y='PC2', df=df_old, path=old_path, file_name='jointplot_senescence', hue="Senescence", colors=('#888888', '#B589C3'),
               hue_order=[0, 1], legend=False, fill=False, thresh=0.2, height=4, ratio=5, space=0, xlabels='UMAP1', ylabel='UMAP2',
               xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax)
...
for cond in np.unique(df['Senescence']):
    draw_umap_space(df[df['Senescence']==cond].reset_index(drop=True), path, file_name='%s_space_type'%cond, condition_name='Type', label_name='pseudo_label',
                    colors = ('#F2B342', '#B56478', '#2983B1'), dot_size=0.07, x_name='PC1', y_name='PC2')
    draw_jointplot(xs='PC1', y='PC2', df=df[df['Senescence']==cond].reset_index(drop=True), path=path, file_name='%s_jointplot_type'%cond, hue="Type",
                   colors=('#F2B342', '#B56478', '#2983B1'), alpha=0.6, legend=False, fill=False,
...
draw_cluster_distribution_heatmap(df_young, young_path, file_name='condition_kmeans_young_heatmap', col_cluster=False, row_cluster=False,
                                  annot=False, vmax=30, cmap=cmc.bilbao_r, condition_name='Senescence', cluster_type='kmeans', figsize=(4,1.5))
draw_cluster_distribution_heatmap(df_mid, mid_path, file_name='condition_kmeans_mid_heatmap', col_cluster=False, row_cluster=False,
                                  annot=False, vmax=30, cmap=cmc.bilbao_r, condition_name='Senescence', cluster_type='kmeans', figsize=(4,1.5))
...
draw_relative_cluster_distribution_heatmap(df_young, young_path, file_name='relative_condition_kmeans_young_heatmap', col_cluster=False, row_cluster=False,
                                  annot=False, vmax=40, cmap=cmc.oslo_r, transpose=False, condition_name='Senescence', cluster_type='kmeans', figsize=(4,1.5))
draw_relative_cluster_distribution_heatmap(df_mid, mid_path, file_name='relative_condition_kmeans_frail_heatmap', col_cluster=False, row_cluster=False,
                                  annot=False, vmax=40, cmap=cmc.oslo_r, transpose=False, condition_name='Senescence', cluster_type='kmeans', figsize=(4,1.5))
...
for cond in np.unique(df['Senescence']):
    draw_cluster_distribution_heatmap(df_young[df_young['Senescence']==cond].reset_index(drop=True), young_path, file_name='%s_age_kmeans_heatmap'%cond, condition_name='Age',
                                      cluster_type='kmeans', transpose=True, cmap=cmc.bilbao_r, row_cluster=False, col_cluster=False, figsize=(10,4))

for cond in np.unique(df['Senescence']):
    draw_cluster_distribution_heatmap(df_mid[df_mid['Senescence']==cond].reset_index(drop=True), mid_path, file_name='%s_age_kmeans_heatmap'%cond, condition_name='Age',
                                      cluster_type='kmeans', transpose=True, cmap=cmc.bilbao_r, row_cluster=False, col_cluster=False, figsize=(5,4))

for cond in np.unique(df['Senescence']):
    draw_cluster_distribution_heatmap(df_old[df_old['Senescence']==cond].reset_index(drop=True), old_path, file_name='%s_age_kmeans_heatmap'%cond, condition_name='Age',
...
df_ = df.copy()
df_['type_senescence'] = df['Type'].astype(str) + ' ' + df['Senescence'].astype(str)
draw_cluster_distribution_heatmap(df_, path, file_name='all_kmeans_heatmap', condition_name='type_senescence', vmax=None,
                                  cluster_type='kmeans', col_cluster=False, row_cluster=True, cmap=cmc.bilbao_r, figsize=(4,4))

for cond in np.unique(df['Senescence']):
    draw_cluster_distribution_heatmap(df[df['Senescence']==cond].reset_index(drop=True), path, file_name='all_age_kmeans_heatmap_%s'%cond, condition_name='Age',
                                      cluster_type='kmeans', transpose=True, row_cluster=False, col_cluster=False, vmax=50, cmap=cmc.bilbao_r, figsize=(12,4))
...
for patient in np.unique(df['Cell Line']):
    each_patient = df[(df['Cell Line']==patient)].reset_index(drop=True)
    for cond in np.unique(each_patient['Senescence']):
        df_part = each_patient[(each_patient['Senescence']==cond)].reset_index(drop=True)
        motility_input = df_part[feature_list]
        pca_input = motility_input.median(axis=0).to_frame().T
        pca_input['Cell Line'] = np.unique(df_part['Cell Line'])[0]
        pca_input['Type'] = np.unique(df_part['Type'])[0]
        pca_input['Senescence'] = np.unique(df_part['Senescence'])[0]
...
pca_inputs_only = pca_inputs.iloc[:, :-5]
scaler = StandardScaler()  # if not normalize, UMAP space is completely different
#aprw_data_scaled = pd.DataFrame(scaler.fit_transform( np.log10( aprw_data+abs(min(aprw_data.min()))+1e-10 ) ), columns=aprw_data.columns)
...
x_name='PC1'
y_name='PC2'
for cond in np.unique(df_patient['Senescence']):
    draw_umap_space(df_patient[df_patient['Senescence']==cond].reset_index(drop=True), path, file_name='%s patient space %s %s'%(cond, x_name, y_name),
                    condition_name='Type', label_name='Cell Line', colors=('#F2B342', '#B56478', '#2983B1'), dot_size=5, x_name=x_name, y_name=y_name)
...
for x_name, y_name in combinations(['PC1', 'PC2', 'PC3', 'PC4'], r=2):
    ...
    draw_diff_arrow_scatter(df_patient, path, file_name='differential response patients %s %s'%(x_name, y_name), condition_name='Type',
                            diff_condition_name='Senescence',ind_name='Cell Line', ref=0, colors=('#F2B342', '#B56478', '#2983B1'),
...
for x_name, y_name in combinations(['PC1', 'PC2', 'PC3', 'PC4'], r=2):
    ...
    for patient in np.unique(df_patient['Cell Line']):  # For patients within condition
        df_part = df_patient[(df_patient['Cell Line'] == patient)].reset_index(drop=True)
        df_ref_ind = df_part[df_part['Senescence'] == 0].reset_index(drop=True)
        ...
        for cond in np.unique(df_part['Senescence']):
            if cond == 0:
                continue
            df_cond_ind = df_part[df_part['Senescence'] == cond].reset_index(drop=True)
        ...
        temp['Cell Line'] = np.unique(df_part['Cell Line'])
    ...
    # grid = sns.PairGrid(data=patient_response, vars=['1 response'],
    ...
    for response in ['1 response']:
        ...
        new_order = ['Young', 'Mid', 'Old']
        dict_patient_response = change_dict_order(dict_patient_response, new_order)
        draw_custom_bar_plot(dict_patient_response, path, file_name='%s bar plot_%s_%s'%(response, x_name, y_name),
                                 strip_plot=True, colors=('#2983B1', '#F2B342', '#B56478'), test='kruskal-wallis_dunn', pvalue=True, figsize=(1, 2))
...
for feature in ['Age']:
    ...
    for row, type in enumerate(['Young', 'Mid', 'Old']):
        for col, cond in enumerate(['1 response']):
            ax = axes[row][col]
...
for group in np.unique(df['Type']):
    ...
    for column in group_clone.columns:
        group_clone.rename(columns={column:'%s '%group+str(column)}, inplace=True)
...
plt.savefig(path+'Type_senescence correlation.png', dpi=300, bbox_inches='tight')

if not os.path.isdir(path + 'svg/'):  # Returns Boolean (if UMAP_fig folder doesn't exist, False)
    os.makedirs(path + 'svg/')
plt.savefig(path + 'svg/Type_senescence correlation.svg', bbox_inches='tight')
...
entropy, max_entropy = calculate_entropy(df_, df_, condition_name='type_senescence', cluster_type='kmeans')

dict_datasets={}
for key in entropy:
    dict_datasets[key] = np.array([entropy[key]])

new_order = ['Young 0', 'Young 1', 'Mid 0', 'Mid 1', 'Old 0', 'Old 1']
dict_datasets = change_dict_order(dict_datasets, new_order)

file_name='total entropy for all conditions'
test='mann-whitney'

colors = ('#2983B1', '#2983B1', '#F2B342', '#F2B342','#B56478', '#B56478',)
...
for group in batches:
    ...
    if df_part.shape[0] == 0:
        continue
    entropy, max_entropy = calculate_entropy(df_part, df, condition_name='Senescence', cluster_type='kmeans')
    for type in entropy:
        if entropy[type]==0:
            continue
        else:
...
entropies_mid = {0: [], 1:[]}
for group in batches:
    df_part = df[(df[group_name]==group)&(df['Type'] == 'Mid')]
    if df_part.shape[0] == 0:
        continue
    entropy, max_entropy = calculate_entropy(df_part, df, condition_name='Senescence', cluster_type='kmeans')
    for type in entropy:
        if entropy[type]==0:
            ...
            entropies_mid[type].append(entropy[type])
...
for cell_type in [0, 1]:
    entropies = {'Young %s'%cell_type:entropies_young[cell_type], 'Mid %s'%cell_type:entropies_mid[cell_type], 'Old %s'%cell_type:entropies_old[cell_type]}
    ...
    draw_custom_bar_plot(entropies, path, file_name='entropy of Type perturbation for %s' %cell_type, colors=('#2983B1', '#F2B342', '#B56478'),
